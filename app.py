...
with tab4:
    ...
    if cluster_toggle:
        ...
        apriori_scaled = scaler.fit_transform(apriori_df[cluster_cols].dropna())
        cluster_labels = kmeans_tmp.fit_predict(apriori_scaled)
        apriori_df = apriori_df.iloc[apriori_df[cluster_cols].dropna().index].copy()
...
with tab5:
    ...
    Xreg = df_reg[feature_cols].fillna(0)
    ...
    # 5.3 Feature Importance for Tree
